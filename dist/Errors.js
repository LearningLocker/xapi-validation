...
exports.subStatementError = function (data) { return function (path) {
...
exports.contextPropError = function (data) { return function (path) {
...
exports.voidError = function (voidVerbId, data) { return function (path) {
...
exports.membersTypeError = function (data) { return function (path) {
...
exports.membersLengthError = function (data) { return function (path) {
    return "An authority group can only contain agents as members in `" + rulr_1.pathString(path) + "`. Please ensure that all members are agents to remove this error.";
}; };
exports.noMembersError = function (data) { return function (path) {
...
exports.noIfiError = function (data) { return function (path) {
...
exports.invalidComponentsError = function (invalidComponents, data) { return function (path) {
...
exports.ifiCountError = function (usedIfis, data) { return function (path) {
