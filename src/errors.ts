...
export const subStatementError = (data: any) =>
  (path: Path) =>
...
export const contextPropError = (data: any) =>
  (path: Path) =>
...
export const voidError = (voidVerbId: string, data: any) =>
  (path: Path) =>
...
export const membersTypeError = (data: any) =>
  (path: Path) =>
...
export const membersLengthError = (data: any) =>
  (path: Path) =>
    `An authority group can only contain agents as members in \`${pathString(path)}\`. Please ensure that all members are agents to remove this error.`;

export const noMembersError = (data: any) =>
  (path: Path) =>
    `An anonymous group must have at least one member in ${pathString(path)}. Please add a member to remove this error.`;

export const noIfiError = (data: any) =>
  (path: Path) =>
...
export const invalidComponentsError = (invalidComponents: string[], data: any) =>
  (path: Path) =>
...
export const ifiCountError = (usedIfis: string[], data: any) =>
  (path: Path) =>
